...
export default function DestinationCard({ name, image, description }) {
  return (
    <Link to="/destinations">
      <div className="w-full border-10 border-[#272727] max-w-md mx-auto aspect-[2/3] rounded-3xl overflow-hidden shadow-[0_12px_30px_-10px_rgba(0,0,0,0.4)] bg-[#0e0e0e] flex flex-col group transition-all duration-300 hover:scale-[1.04]">
        ...
        <div className="h-[30%] flex flex-col justify-between px-6 py-4 text-white bg-[#272727]">
          <div>
            <h2 className="text- font-ubuntu font-semibold  group-hover:text-[#d8c4b6] transition-colors">
              {name.toUpperCase()}
            </h2>
