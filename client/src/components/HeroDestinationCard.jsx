...
export default function HeroDestinationCard({
  ...
  const thumbnail = mediaGallery[0];
  ...
  if (featured) {
    return (
      <div
        className={`grid lg:grid-cols-2 overflow-hidden rounded-[8px] border border-neutral-200 bg-white transition-opacity duration-300 ${
          fade
            ? "opacity-0"
            : "opacity-100"
        }`}
